...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Update header links based on authentication and role
  updateHeaderLinks();
});
...
// Script to manage header links visibility based on user role and authentication status
function updateHeaderLinks() {
  ...
  if (token && user) {
    ...
    if (user.role === 'teacher') {
      if (teacherDashboardLink) teacherDashboardLink.style.display = 'inline';
    } else {
      if (teacherDashboardLink) teacherDashboardLink.style.display = 'none';
    }
  } else {
    if (signinLink) signinLink.style.display = 'inline';
    if (createProfileLink) createProfileLink.style.display = 'inline';
    if (teacherDashboardLink) teacherDashboardLink.style.display = 'none';
...
function logout() {
 ...
 // Authentication check function
    function checkAuthAndRedirect(url) {
      ...
      // User is authenticated, proceed to course
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (user.role === 'teacher') {
        document.getElementById('teacherDashboardLink').style.display = 'inline-block';
      }
      if (user.role === 'student') {
        document.getElementById('studentDashboardLink').style.display = 'inline-block';
      }
    });
